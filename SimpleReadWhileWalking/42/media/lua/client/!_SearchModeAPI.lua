----------- SEARCH MODE API -------------
-- You CAN copy this file and include it in your mod
-- to avoid annoying dependency.
-- But as a separate mod it's be better because of possible updates.
-----------------------------------------


if SearchModeAPI then
  return
end
