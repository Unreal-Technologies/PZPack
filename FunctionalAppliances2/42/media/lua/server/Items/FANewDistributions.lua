local FA_DistributionTable = {
    	all = {
        	...
        	pegBoard = {
            		procedural = true,
            		procList = {
                		{name="Pegboards", min=0, max=99, forceForTiles="location_business_machinery_01_24;location_business_machinery_01_25;location_business_machinery_01_26;location_business_machinery_01_27", weightChance=50},
            		}
        	},
        	poolCueStand = {
            		procedural = true,
            		procList = {
                		{name="PoolCues", min=0, max=99, forceForTiles="recreational_01_4;recreational_01_5", weightChance=50},
            		}
        	},
        	napkinDispenser = {
            		procedural = true,
