...
FA.translation = {
	...
	markeractivated = getText("UI_FunctionalAppliances_markeractivated"),
	markerdeactivated = getText("UI_FunctionalAppliances_markerdeactivated"),
	activatemarker = getText("UI_FunctionalAppliances_activatemarker"),
	deactivatemarker = getText("UI_FunctionalAppliances_deactivatemarker"),
	powerconsumption = getText("UI_FunctionalAppliances_powerconsumption"),
	addfuel = getText("UI_FunctionalAppliances_addfuel"),
	addallfuel = getText("UI_FunctionalAppliances_addallfuel"),
