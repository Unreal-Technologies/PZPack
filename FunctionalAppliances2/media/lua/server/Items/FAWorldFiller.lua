...
-- pool Cue Stands
overlayMap["recreational_01_4"] = {{ name = "other", tiles = {"overlay_pool_cue_stand_01_0"} }}
overlayMap["recreational_01_5"] = {{ name = "other", tiles = {"overlay_pool_cue_stand_01_3"} }}
--overlayMap["recreational_01_4"] = {{ name = "other", tiles = {"overlay_pool_cue_stand_01_2", "overlay_pool_cue_stand_01_0"} }}
--overlayMap["recreational_01_5"] = {{ name = "other", tiles = {"overlay_pool_cue_stand_01_3", "overlay_pool_cue_stand_01_1"} }}
