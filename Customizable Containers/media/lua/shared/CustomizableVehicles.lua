local function AlterVehicleProperties()
    ...
    { modID = "ATA_Bus", parts = CContainers.VehiclePartsTsarBus, storage = CContainers.VehicleStorageTsarBus },
    ...
    { modID = "amclub", storage = CContainers.VehicleStorageTsaramclub },
    ...
    { modID = "isoContainers", storage = CContainers.VehicleStorageisoContainers },
...
Events.OnSpawnRegionsLoaded.Add(AlterVehicleProperties)
Events.OnLoad.Add(AlterVehicleProperties)