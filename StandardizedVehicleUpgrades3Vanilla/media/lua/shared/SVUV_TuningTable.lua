...
--		NewCarTuningTable["CarLightsPolice"] = NewCarTuningTable["CarLights"]
		...
		if getActivatedMods():contains("STFR") then
			NewCarTuningTable["StepVan_swat"] = NewCarTuningTable["Van"]
			NewCarTuningTable["Van_doc"] = NewCarTuningTable["Van"]
			NewCarTuningTable["STFR_87gmcarmoredcar"] = NewCarTuningTable["PickUpVan"]
		end
