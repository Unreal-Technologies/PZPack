...
local wPaintMenuItems = {	
	{ paint = "Wallpaper_BlueStripe",        text = "ContextMenu_BlueStripes",    		color = { 0.55,0.55,0.87 } },
    { paint = "Wallpaper_BeigeStripe",       text = "ContextMenu_BeigeStripes",  		color = { 0.84,0.78,0.30 } },	
	{ paint = "Wallpaper_YellowPinkStripes", text = "ContextMenu_YellowChevron",  		color = { 0.84,0.78,0.30 } },	
    { paint = "Wallpaper_PinkChevron",       text = "ContextMenu_PinkChevron",  		color = { 0.84,0.78,0.30 } },	
	{ paint = "Wallpaper_GreenDiamond",  	 text = "ContextMenu_GreenDiamond", 		color = { 0.41,0.80,0.41 } },
	{ paint = "Wallpaper_GreenFloral",  	 text = "ContextMenu_GreenFloral", 			color = { 0.41,0.80,0.41 } },
	{ paint = "Wallpaper_PinkFloral",  		 text = "ContextMenu_PinkFloral", 			color = { 0.81,0.60,0.60 } },
	{ paint = "Wallpaper_BlackFloral",  	 text = "ContextMenu_BlackFloral", 			color = { 0.92,0.92,0.92 } },
	{ paint = "Wallpaper_BlueDots",  		 text = "ContextMenu_BlueDots", 			color = { 0.35,0.35,0.80 } },
	{ paint = "Wallpaper_RedScales",  		 text = "ContextMenu_RedScales", 			color = { 0.52,0.25,0.38 } },
	{ paint = "Wallpaper_BlueOrnament",  	 text = "ContextMenu_BlueOrnament", 		color = { 0.35,0.35,0.80 } },
	{ paint = "Wallpaper_GreenOrnament",  	 text = "ContextMenu_GreenOrnament", 		color = { 0.41,0.80,0.41 } },
	{ paint = "Wallpaper_RedOrnament",  	 text = "ContextMenu_RedOrnament", 			color = { 0.63,0.10,0.10 } },
	{ paint = "Wallpaper_FlowersOnWhite",  	 text = "ContextMenu_FlowersOnWhite", 		color = { 0.89,0.84,0.75 } },
	{ paint = "Wallpaper_GreenGeometry",  	 text = "ContextMenu_GreenGeometry", 		color = { 0.31,0.38,0.24 } },
	{ paint = "Wallpaper_OrangeFlowers",  	 text = "ContextMenu_OrangeFlowers", 		color = { 0.79,0.44,0.19 } },
	{ paint = "Wallpaper_GreeneryWP",  	 	 text = "ContextMenu_GreeneryWP", 			color = { 0.41,0.80,0.41 } },
	{ paint = "Wallpaper_GoldenStripes",  	 text = "ContextMenu_GoldenStripes", 		color = { 0.31,0.38,0.24 } },
	{ paint = "Wallpaper_PeachOrnament",  	 text = "ContextMenu_PeachOrnament", 		color = { 0.89,0.56,0.51 } },
	}
...
--	New Plaster (can plaster all wooden walls (not siding) and all brick walls)
	if (joypad or plasterableWall) and ((playerObj:getPerkLevel(Perks.Woodwork) >= 4 and plasterTrowel and plaster) or ISBuildMenu.cheat) then
		if test then return ISWorldObjectContextMenu.setTest() end
...
--	remove tiles
	...
	-- Apply Tiles
	if (joypad or toTileWall) and (plasterTrowel or ISBuildMenu.cheat) then
