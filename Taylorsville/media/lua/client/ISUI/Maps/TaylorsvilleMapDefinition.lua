...
LootMaps.Init.TaylorsvilleMap = function(mapUI)
    local mapAPI = mapUI.javaObject:getAPIv1()
    MapUtils.initDirectoryMapData(mapUI, 'media/maps/Taylorsville')
    ...
    mapAPI:setBoundsInSquares( 9150, 6450, 10498, 7199)
    -- (starting x, starting y, ending x, ending y) of the area you want to display and uncover, in World Co-ordinates.



    overlayPNG(mapUI, 9150, 6450, 1 , "water", "media/textures/worldMap/TaylorsvilleWaterBackground.png")
    -- Add water background to missing cell.



    overlayPNG(mapUI, 9180, 6480, 0.6 , "badge", "media/textures/worldMap/TaylorsvilleBadge.png")
    -- Add your lootable maps banner PNG.



    overlayPNG(mapUI, 9180, 7000, 0.7 , "legend", "media/textures/worldMap/TaylorsvilleLegend.png")
    -- Add the legend PNG.
